...
Drawing the DAG is the discipline that tells you what to adjust for — and, crucially, what **not** to adjust for. Three structures every candidate should be able to distinguish:
...
Typical variance reductions of 30–50% translate directly into shorter experiments — the single highest-leverage improvement to most experimentation platforms.
